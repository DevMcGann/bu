...
import { SizeChartPage } from '../../views/SizeChart';
...
export const Routes: React.FC = () => (
  <Switch>
    ...
    <Route path={paths.contactPageUrl} component={ContactPage} />
    <Route path={paths.sizeChartPageUrl} component={SizeChartPage} />
