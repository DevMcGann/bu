...
- Headless ecommerce storefront based on [Saleor](https://github.com/mirumee/saleor/). It was built with [GraphQL](https://graphql.org/), [Apollo Client](https://www.apollographql.com/client), [React](https://reactjs.org/) and [Typescript](https://www.typescriptlang.org/)
- Offline mode (beta)
...
See the [public demo](https://puzzle-ecommerce-prod.herokuapp.com/).
...
```
git clone https://gitlab.com/puzzle3/saleor-ecommerce/saleor-front.git
```

#### Installing dependencies and run the server.
...
This project is based on Saleor Storefront, which is licensed under the BSD-3-Clause License - see the [LICENSE](https://github.com/mirumee/saleor-storefront/blob/master/LICENSE) file for details.
